...
//   balisesVue = ["FR_SALM", "NL_SALM", "NL_CYCLO", "EN_SALM", "EN_CYCLO"]
// }
// if(Router.current().route.path()=="\/pupitre"){
//   balisesVue = ["FR"]
// }
// if(Router.current().route.path()=="\/NL_SAT"){
//   balisesVue = ["NL_SAT", "NL"]
// }
// if(Router.current().route.path()=="\/EN_SAT"){
//   balisesVue = ["EN_SAT", "EN"]
// }
// if(Router.current().route.path()=="\/admin"){
//   balisesVue = ["FR_CYCLO", "FR_SALM"]
// }
