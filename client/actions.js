...
finishCuppa = function(e){
  ...
  if (!areYouSureYouAreComfy) {
    ...
    switch(TAPi18n.getLanguage()){
      case "fr":
        $("#srt").html("Attendez, vous êtes bien installé·e, bien bien confortablement ? <br/> Vous avez encore le temps de parfaire votre installation avant de confirmer que vous avez bien terminé.")
